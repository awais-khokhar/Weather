...
# in /home/ma/Android/Sdk/tools/proguard/proguard-android.txt
...
#---------------------------------实体类---------------------------------
#修改成你对应的包名
-keep class top.maweihao.weather.bean.** { *; }
...
#下面中括号的地方需要要填你的包名
-keep public class top.maweihao.weather.R$*{
...
-keep class top.maweihao.weather.view.** { *; }
