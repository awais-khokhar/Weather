    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && mApplication.getExternalCacheDir() != null)
                sDefaultDir = mApplication.getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                sDefaultDir = mApplication.getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
